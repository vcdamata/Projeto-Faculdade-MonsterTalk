...
| RF-005 | O sistema deve disponibilizar fóruns ou comunidades entre pais, professores e alunos. | BAIXA |
| RF-006 | A plataforma deve permitir integração com assistentes de voz para prática oral. | BAIXA |
